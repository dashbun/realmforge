...
const WorldDetailPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
      ...
      <div className="border-b border-gray-200 dark:border-white/20 bg-white dark:bg-gray-800">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-300">{characters.length}</span>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-300">{maps.length}</span>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-300">{powerSystems.length}</span>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-sm text-gray-500 dark:text-gray-300">{lore.length}</span>
              </div>
              
              {lore.length > 0 ? (
                <div className="space-y-3 mb-4">
                  {lore.slice(0, 2).map(loreEntry => (
                    <div key={loreEntry.id} className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center mr-3">
                        <Book className="h-4 w-4 text-green-800 dark:text-green-200" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">
                          {loreEntry.title}
        ...
        {activeTab === 'characters' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Characters</h2>
              <Button
                variant="primary"
        ...
        {activeTab === 'maps' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Maps</h2>
              <Button
                variant="primary"
                icon={<Plus className="h-5 w-5" />}
                onClick={() => {
        ...
        {activeTab === 'powers' && (
          <div>
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Power Systems</h2>
              <Button
                variant="primary"
                icon={<Plus className="h-5 w-5" />}
                onClick={() => {
        ...
        {activeTab === 'lore' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Lore Entries</h2>
              <Button
                variant="primary"
                icon={<Plus className="h-5 w-5" />}
                onClick={() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {lore.map((l: Lore) => (
                  <div key={l.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
                    <h3 className="font-semibold text-lg mb-2 text-gray-900 dark:text-gray-100">{l.title}</h3>
                    <p className="text-gray-600 dark:text-gray-300 mb-2">{l.category}</p>
